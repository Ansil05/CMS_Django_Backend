...
class Staff(models.Model):
    ...
    # FIXED: Changed from Group to Role model
    # Old: Role = models.ForeignKey(Group, on_delete=models.SET_NULL, null=True)
    # New: Use related_name to avoid field name conflict
    StaffRole = models.ForeignKey('Role', on_delete=models.SET_NULL, null=True, related_name='staff_members')
...
class Doctor(models.Model):
    ...
    def __str__(self):
        return f"Dr. {self.Staff.FirstName} {self.Staff.LastName} - {self.Specialization.SpecializationName if self.Specialization else 'No Specialization'}"
